...
import (
	...
	cloudedge "igitlab.lenovo.com/lecp/mec/bailu/client/informers/externalversions/cloud.edge"
...
type SharedInformerFactory interface {
	...
	Cloud() cloudedge.Interface
}

func (f *sharedInformerFactory) Cloud() cloudedge.Interface {
	return cloudedge.New(f, f.namespace, f.tweakListOptions)
}
